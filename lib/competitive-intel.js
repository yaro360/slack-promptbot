const { competitors, sources, schedule, signalTags } = require('../config/competitors');
const { fetchRedditSignals } = require('./sources/reddit');
const { fetchGoogleAlerts, fetchCompetitorBlog } = require('./sources/rss');
const { fetchHackerNews, fetchTechCrunch } = require('./sources/news');
...
async function collectAllSignals() {
  ...
  const results = await Promise.allSettled([
    fetchRedditSignals(competitorNames),
    fetchHackerNews(competitorNames),
